...
################################### Gage Component ###################################
densityLP3_gage<-function(parameters,data,gage_uncertainty){
...
densityLP3_hist<-function(parameters,hist,hist_uncertainty){
...
########################################### Paleo Component ################################
densityLP3_paleo <- function(parameters, data, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty){
  #  I <- length(paleo_age)
  #  paleo_age <- paleo_age
  ...
  #    
  #    like[i] <- sum(FUnij*Nij)*sum(FUdik*intvect)
  #  }
  ...
  #  out <- (like*dbinom(length(paleo_age), size = paleo_age, prob = (1-LP3prob(paleo_flow_lower, parameters)))/
  #         (1-LP3prob(paleo_flow_lower, parameters)))
  return(out)
}
####################################### Complete Likelihood Function ##############################
# gage historical and paleo likelihood function
LP3_gage_hist_paleo <- function(parameters, data, gage_uncertainty, hist, hist_record, hist_uncertainty, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty){
  density <- c(densityLP3_gage(parameters, data, gage_uncertainty),
               densityLP3_hist(parameters, hist, hist_uncertainty),
               densityLP3_paleo(parameters, data, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty))
  loglik <- sum(log(density))
  if(is.na(loglik)==TRUE)(loglik=-Inf)
  return(loglik)
}

#LP3_gage_hist_paleo_MLE <- function(parameters, data, gage_uncertainty, hist, hist_record, hist_uncertainty, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty){
LP3_gage_hist_paleo_MLE <- function(parameters, data, gage_uncertainty, hist, hist_record, hist_uncertainty, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty){
  density <- c(densityLP3_gage(parameters, data, gage_uncertainty),
               densityLP3_hist(parameters, hist, hist_uncertainty),
               densityLP3_paleo(parameters, data, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty))
...
# density of LP3
densityLP3 <- function(parameters, data, gage_uncertainty, hist, hist_record, hist_uncertainty, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty){
  density <- c(densityLP3_gage(parameters, data, gage_uncertainty),
               densityLP3_hist(parameters, hist, hist_uncertainty),
               densityLP3_paleo(parameters, data, paleo_flow_upper, paleo_flow_lower, paleo_age, paleo_age_uncertainty, paleo_flow_uncertainty))
  return(density)
